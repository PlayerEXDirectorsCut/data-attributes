...
open class DataAttributesConfigScreen(parent: Screen?, wrapper: ConfigWrapper<*>) : ConfigScreen(DEFAULT_MODEL_ID, wrapper, parent) {
    companion object Factory {
                    ...
                    Containers.collapsible(Sizing.content(), Sizing.content(), Text.literal("[$id]"), true)
                        .also {
                            ...
                            it.child(textBoxComponent(
                                ...
                                onChange = {
                                    this.backing.remove(id)
                                    this.backing.put(id, override.copy(min_fallback = it.toDouble()))
                                }
                            ))
                            ...
                            it.child(textBoxComponent(
                                ...
                                onChange = {
                                    this.backing.remove(id)
                                    this.backing.put(id, override.copy(max_fallback = it.toDouble()))
                                }
                            ))
        ...
        fun textBoxComponent(txt: Text, obj: Any, predicate: Predicate<String>? = null, onChange: ((String) -> Unit)?): FlowLayout {
